...
export function TypographyLarge({ children, className, ...props }: React.ComponentProps<'div'>) {
	return (
...
export function TypographyMuted({ children, className, ...props }: React.ComponentProps<'p'>) {
	return (
