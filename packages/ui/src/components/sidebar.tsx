...
import {
	...
	TooltipProvider,
	TooltipTrigger,
} from '@ski-blazek/ui/components/tooltip'
...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: <This file is created bz shadcn/ui>
...
function SidebarMenuSkeleton({
	...
	// Varied width between 50 to 90%, derived from the instance id so it stays
	// pure during render (Math.random() here trips react-hooks/purity).
